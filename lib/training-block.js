...
export const BLOCK_PROGRESSION_NOTES = [
  ...
  "Pull-ups: four sets at 1–2 RIR. Finish each set with one or two clean reps still available; reps can vary by set. Compare A with A and B with B.",
...
export function buildTrainingBlockWorkouts(regularWorkouts) {
  ...
  const pullUps = () => exercise("Pull-Ups", [0, 0, 0, 0], null, 180,
    { targetRir: [1, 2], grips: ["pullup", "chinup", "neutral"],
