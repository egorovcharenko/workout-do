...
export function buildTrainingBlockWorkouts(regularWorkouts, revision = TRAINING_BLOCK_PRESCRIPTION_REVISION) {
  ...
  const core = () => exercise("Dragon Fly Progression", [null, null, null], [3, 8], 90, null,
  ...
  return [
    ...
    workout("strength-accessories-1", BLOCK_NAMES[1], "Accessories 1 · Dips & Arms", [
      ...
      exercise("Bayesian Cable Curl", [20, 20, 20], [6, 15], 90, 1.25),
      exercise("Single-Arm Cable Rear Delt Fly", [15, 15, 15], [8, 15], 90, 1.25,
        { historySourceWorkout: "Strength Accessories 2" }),
      exercise("Dumbbell Hammer Curls", [30, 30, 30], [5, 12], 90, 2.5),
      exercise("Overhead Tricep Extension", [35, 35, 35], [6, 15], 90, 1.25), core(),
      { ...WRIST_CURL },
    ], false),
    ...
    workout("strength-accessories-2", BLOCK_NAMES[3], "Accessories 2 · Delts & Traps", [
      { ...CABLE_CHEST_FLY },
      exercise("Single-Arm Cable Lateral Raise", [15, 15, 10], [6, 15], 90, 1.25),
      exercise("Barbell Shrugs", [135, 205, 205, 205], [[10, 12], [6, 15], [6, 15], [6, 15]], 120, 5),
      exercise("Single-Arm Cable Rear Delt Fly", [15, 15, 15], [8, 15], 90, 1.25),
      exercise("Incline DB Curls", [20, 20, 20], [6, 15], 90, 2.5),
      exercise("Cable Tricep Pushdowns", [55, 55, 55], [5, 12], 90, 1.25),
      exercise("Calf Raises", [55, 55, 55], [15, 20], 90, 1.25), core(),
      { ...WRIST_CURL },
    ], false),
  ];
}
