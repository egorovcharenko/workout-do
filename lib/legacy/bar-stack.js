...
// Read without changing the visualizer's state; reject a stale exercise/load.
function recordedBarStack(exercise, weight) {
  return barStack.exercise === exercise && totalWeight(barStack.plates) === weight
    ? [...barStack.plates] : null;
}

export { currentBarStack, setBarStack, recordedBarStack };
