...
function calcSet1RMFromEffectiveWeight(exerciseName, effectiveWeight, reps, bandsJson, grip) {
...
function calcStoredSet1RM(exerciseName, weight, reps, bandsJson, grip, session) {
  return calcSet1RMFromEffectiveWeight(
    exerciseName,
