...
const WORKOUTS = [
  ...
  },
  {
    ...
    exercises: [
      ...
      // and pushdowns both load the short position. Flyes and hammers stay
      // standalone: supersets must not share a tool, and both use dumbbells.
      { name: "Reverse Flyes", equipment: "dumbbell", sets: 3, reps: "15-20", rest: 60, noWarmup: true, video: "https://www.youtube.com/shorts/LsT-bR_zxLo", notes: "Rear delts — second weekly hit alongside Shrugs-day cable rear delt flyes." },
...
// The regular program stays unchanged. Block workouts have separate names,
// history, and URLs, and are selected only while a block is active.
...
const ALL_WORKOUTS = [...WORKOUTS, ...BLOCK_WORKOUTS];
...
export {
  ...
  LEGACY_WORKOUT_NAMES, WORKOUTS, BLOCK_WORKOUTS, LEGACY_BLOCK_WORKOUTS, ALL_WORKOUTS, localDate, interleavedSetNumber, DELOAD_EXPIRY_DAYS, isDeloadActive,
