...
const WORKOUTS = [
  ...
  },
  {
    ...
    exercises: [
      { name: "Dips", sets: 3, reps: "8-12", repsOnly: true, rest: 75, noWarmup: true, video: "https://www.youtube.com/shorts/0326dy_-CzM", notes: "Real triceps load." },
      ...
      { name: "Reverse Flyes", sets: 3, reps: "15-20", rest: 60, noWarmup: true, video: "https://www.youtube.com/shorts/LsT-bR_zxLo", notes: "Rear delts — second weekly hit alongside Shrugs-day cable rear delt flyes." },
      { name: "Dumbbell Hammer Curls", sets: 3, reps: "10-15", rest: 60, noWarmup: true, video: "https://www.youtube.com/shorts/0IAJqSwFnHI", notes: "Focus on hammer grip." },
      { name: "Lunges", sets: 3, reps: "10-12", rest: 90, noWarmup: true, notes: "DB lunges, 10-12 per leg. Weekly quad/glute volume beyond the squat day." },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Incline DB Curls", sets: 2, reps: "10-15", rest: 60, noWarmup: true, notes: "Stretch-biased biceps." },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Dips", sets: 3, reps: "8-12", rest: 60, noWarmup: true, repsOnly: true, video: "https://www.youtube.com/shorts/0326dy_-CzM" },
      { name: "Dumbbell Hammer Curls", sets: 3, reps: "8-12", rest: 60, noWarmup: true, video: "https://www.youtube.com/shorts/0IAJqSwFnHI" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Dumbbell Bicep Curls", sets: 3, reps: "8-12", rest: 60, noWarmup: true, video: "https://www.youtube.com/shorts/MKWBV29S6c0" },
    ],
  },
  {
...
const SWAP_GROUPS = [
  ...
  { family: "Biceps (Arm Flexion)", exercises: [
    { name: "Dumbbell Bicep Curls", sets: 2, reps: "8-12", video: "https://www.youtube.com/shorts/MKWBV29S6c0" }, { name: "Bayesian Cable Curl", sets: 2, reps: "10-15", equipment: "cable", rest: 60, noWarmup: true }, { name: "Incline DB Curls", sets: 2, reps: "10-15", rest: 60 },
    { name: "Dumbbell Hammer Curls", sets: 3, reps: "8-12", video: "https://www.youtube.com/shorts/0IAJqSwFnHI" }, { name: "Band Bicep Curls", sets: 2, reps: "12-15", video: "https://www.youtube.com/shorts/5ACsDBt_sMQ", equipment: "band" }
  ]},
