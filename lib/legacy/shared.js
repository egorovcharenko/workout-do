...
const DRAGON_FLAG_DEMO_PAGE = "https://bodyweighttrainingarena.com/dragon-flag-progression/";
const dragonFlagDemo = (file) => `https://i0.wp.com/bodyweighttrainingarena.com/wp-content/uploads/2015/12/${file}?resize=240%2C160&quality=40&ssl=1`;
const DRAGONFLY_STAGES = [
  {
    id: "tuck", label: "Tuck Dragon Flag", hint: "short lever · knees in",
    demoUrl: dragonFlagDemo("Dragon-flag-tucks-lower-down.gif"),
    demoSourceUrl: DRAGON_FLAG_DEMO_PAGE,
    demoAlt: "Animated demonstration of a tuck dragon flag lowering",
  ...
  },
  {
    ...
    demoUrl: dragonFlagDemo("Dragon-Flag-one-leg_Gif_Small_360x240_10-MB.gif"),
    demoSourceUrl: DRAGON_FLAG_DEMO_PAGE,
    demoAlt: "Animated demonstration of a single-leg dragon flag",
  ...
  },
  {
    ...
    demoUrl: dragonFlagDemo("Dragon-Flag-Straddle_Gif_Small_360x240_13-MB.gif"),
    demoSourceUrl: DRAGON_FLAG_DEMO_PAGE,
    demoAlt: "Animated demonstration of a straddle dragon flag",
  ...
  },
  {
    ...
    demoUrl: dragonFlagDemo("Dragon-Flag-Full_Gif_Small_360x240_11.2-MB.gif"),
    demoSourceUrl: DRAGON_FLAG_DEMO_PAGE,
    demoAlt: "Animated demonstration of a full dragon flag used to show the negative phase",
  ...
  },
  {
    ...
    demoUrl: dragonFlagDemo("Dragon-Flag-Full_Gif_Small_360x240_11.2-MB.gif"),
    demoSourceUrl: DRAGON_FLAG_DEMO_PAGE,
    demoAlt: "Animated demonstration of a full dragon flag repetition",
  ...
  },
  {
    ...
    demoUrl: dragonFlagDemo("Dragon-Flag-Full_Gif_Small_360x240_11.2-MB.gif"),
    demoSourceUrl: DRAGON_FLAG_DEMO_PAGE,
    demoAlt: "Animated demonstration of strict full-range dragon flag repetitions",
