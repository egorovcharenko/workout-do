...
const WORKOUTS = [
  {
    ...
    exercises: [
      { name: "Barbell Back Squat", sets: 3, warmups: 3, reps: "1x5-8, 2x8-10", notes: "Top set: 5–8 reps @ 1–2 RIR, +5 lb at 8. Then 2 back-offs around 90% for 8–10 reps, +5 lb only when both hit 10. No grinders; stop if depth or bracing slips. Set safety pins low.", equipment: "barbell", rest: 150, defaultWarmup: [45, 75, 95], defaultWarmupReps: [10, 5, 5], defaultWork: [125, 115, 115], defaultWorkReps: [6, 8, 8] },
...
const SWAP_GROUPS = [
  { family: "Deadlifts & Hinge (Posterior)", exercises: [
    { name: "Barbell RDL", sets: 3, warmups: 3, reps: "6-10", equipment: "barbell", rest: 120 }, { name: "Barbell Back Squat", sets: 3, warmups: 3, reps: "6-8", equipment: "barbell", rest: 120 },
  ...
  { family: "Squats & Quads (Legs)", exercises: [
    { name: "Barbell Back Squat", sets: 3, warmups: 3, reps: "6-8", equipment: "barbell", rest: 120 }, { name: "Barbell RDL", sets: 3, warmups: 3, reps: "6-10", equipment: "barbell", rest: 120 },
