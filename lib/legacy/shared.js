...
const WORKOUTS = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Dragon Fly Progression", sets: 2, reps: "3-8", rest: 90, stages: DRAGONFLY_STAGES, noWarmup: true, assist: true, notes: "Pick your stage below. 8 clean reps on all sets -> move up a stage. Slow lowering, lower back stays pressed down." },
    ],
  },
  {
