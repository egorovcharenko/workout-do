...
const WORKOUTS = [
  ...
  },
  {
    ...
    exercises: [
      ...
      // OHP, so this slot goes to rear delts (otherwise only 2 face-pull sets
      ...
      { name: "Reverse Flyes", sets: 3, reps: "15-20", rest: 60, noWarmup: true, video: "https://www.youtube.com/shorts/LsT-bR_zxLo", notes: "Rear delts — second weekly hit alongside Shrugs-day face pulls." },
