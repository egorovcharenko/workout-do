...
const WORKOUTS = [
  {
    ...
    exercises: [
      ...
      { name: "Pull-Ups", sets: 3, reps: "1-12", notes: "1. Fresh attempt (1 unassisted). 2. Set 1–2: assisted. 3. Set 3: negatives (3-5s lowering). Top set hits 12 -> REDUCE assistance.", equipment: "band", assist: true, grips: ['pullup', 'neutral', 'chinup'], rest: 150, noWarmup: true },
  ...
  },
  {
    ...
    exercises: [
      { name: "Dips", sets: 3, reps: "8-12", assist: true, video: "https://www.youtube.com/shorts/0326dy_-CzM", notes: "Real triceps load.", rest: 60, noWarmup: true },
      ...
      { name: "Cable Torso Rotation", sets: 2, reps: "12-15", equipment: "cable", rest: 45, notes: "Rotate left/right.", noWarmup: true },
  ...
  },
  {
    ...
    exercises: [
      { name: "Single-Arm Cable Lateral Raise", sets: 3, reps: "12-20", rest: 45, notes: "Second weekly delt hit. Cable keeps constant tension.", equipment: "cable", noWarmup: true },
      { name: "Cable Face Pulls", sets: 2, reps: "15-20", equipment: "cable", rest: 45, notes: "Rear delt + upper trap; pull pulley to forehead.", noWarmup: true },
      { name: "Barbell Shrugs", sets: 3, reps: "12-20", rest: 45, notes: "Pause + squeeze; trap priority.", noWarmup: true, equipment: "barbell" },
      { name: "Reverse Flyes", sets: 2, reps: "12-20", video: "https://www.youtube.com/shorts/LsT-bR_zxLo", rest: 45, notes: "Rear delt.", noWarmup: true },
      { name: "Cable Tricep Pushdowns", sets: 2, reps: "10-15", equipment: "cable", video: "https://www.youtube.com/shorts/eGjSphOefTI", rest: 60, notes: "Constant tension tricep work.", noWarmup: true },
      { name: "Incline DB Curls", sets: 2, reps: "10-15", rest: 60, notes: "Stretch-biased biceps.", noWarmup: true },
      { name: "Hanging Knee Raise", sets: 2, reps: "10-15", rest: 45, noWarmup: true, assist: true },
      { name: "Dragon Fly Progression", sets: 2, reps: "3-8", rest: 90, stages: DRAGONFLY_STAGES, notes: "Pick your stage below. 8 clean reps on all sets -> move up a stage. Slow lowering, lower back stays pressed down.", noWarmup: true, assist: true },
    ],
  },
  {
    ...
    exercises: [
      ...
      { name: "Sleeve-Buster Superset", sets: 3, reps: "15", rest: 60, supersetExercises: [{ name: "Dips", reps: "8-12", assist: true, video: "https://www.youtube.com/shorts/0326dy_-CzM" }, { name: "Dumbbell Hammer Curls", reps: "8-12", video: "https://www.youtube.com/shorts/0IAJqSwFnHI", grips: ['hammer', 'supinated', 'reverse'] }]},
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Pull-Ups", sets: 4, reps: "5-8", video: "https://www.youtube.com/shorts/0sRmDbT9Pm0", equipment: "band", assist: true, grips: ['neutral', 'chinup', 'pullup'], rest: 120, noWarmup: true },
...
const SWAP_GROUPS = [
  ...
  { family: "Back Rows & Pulls (Pull)", exercises: [
    { name: "Pull-Ups", sets: 4, reps: "5-8", video: "https://www.youtube.com/shorts/0sRmDbT9Pm0", equipment: "band", assist: true, grips: ['neutral', 'chinup', 'pullup'], rest: 120, noWarmup: true }, { name: "Single-Arm Dumbbell Rows", sets: 3, reps: "8-12", video: "https://www.youtube.com/shorts/H8jf3DwlIlo", rest: 120 },
...
export {
  ...
  estimateActiveWorkoutDuration, estimateTemplateWorkoutDuration,
};
