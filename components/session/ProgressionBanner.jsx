...
function ProgressionBanner({ exercise }) {
  ...
  return (
    <section className={`prog-banner ${styles.banner} ${tone} ${paused ? styles.paused : ""}`} aria-label={`${progression.exercise} progression`}>
      <div className={styles.copy}>
        ...
        <p className="compact-hide">{progression.detail}</p>
      </div>
