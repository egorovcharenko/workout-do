    ...
    <div className={`active-set-block${exercise.isBarbell ? " active-set-barbell" : ""}`} style={{
      ...
      <div className="rep-entry-dock">
        ...
        {guidance && <div className="rep-guidance">
          ...
          {guidance.rirLabel && <span className="rep-suggested-label" title={`Finish with ${guidance.rirLabel} clean reps still available.`}>Target <strong>{guidance.rirLabel} RIR</strong></span>}
