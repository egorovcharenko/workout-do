export function LoadProgression({ offer, onApply }) {
  ...
  const condition = offer.practice ? "3 reps left and main squat steady?" : "1–2 reps left both times?";
  return (
    <div className="load-guidance" data-load-progression={offer.ready ? "ready" : "building"}>
      ...
      {offer.canApply && onApply ? <>
        ...
        <button type="button" onClick={onApply}
          aria-label={`Confirm ${offer.practice ? '3 reps in reserve and main squat steady' : '1–2 reps in reserve in both workouts'}; use ${offer.weight} lb for ${offer.groupLabel}`}>
