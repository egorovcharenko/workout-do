    ...
    <WeightSelectionFrame
      ...
      visual={(
        <div style={{ width: "100%", height: "100%", minHeight: 80, position: "relative", display: "flex", justifyContent: "center" }}>
          ...
          <div style={{ position: "absolute", top: 24, width: 2, height: 22, background: "repeating-linear-gradient(#CBD5E1 0 3px, #475569 3px 6px)" }} />
          {loaded.length > 0 && (
            <div style={{ position: "absolute", top: 40, left: "3%", right: "3%", display: "flex", alignItems: "center", justifyContent: loaded.length < 4 ? "center" : "flex-start", overflowX: "auto", padding: "2px 2px 4px", WebkitOverflowScrolling: "touch" }}>
      ...
      controls={(
        <div style={{ display: "flex", flexDirection: "column", gap: 9, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 5, overflowX: "auto", paddingBottom: 2 }}>
            ...
            {weight > 0 && (
              <button type="button" onClick={() => onWeightChange(0)} style={{ border: 0, background: "transparent", color: T.red, fontFamily: T.mono, fontSize: 9, fontWeight: 800, cursor: "pointer", padding: "0 4px", flex: "0 0 auto" }}>CLEAR</button>
            )}
          </div>
        </div>
      )}
