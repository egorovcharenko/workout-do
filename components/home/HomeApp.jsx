...
import { loadProgressShare, shareProgress, copyProgressLink, stopSharingProgress } from "./progressShare";
import {
  sparkTip,
  microSparkline,
...
import { openSLHistorySync, closeSLHistorySync } from "./strengthLevelSync";
...
function initHomeApp() {
  ...
  Object.assign(window, {
    ...
    submitMeasurement,
    deleteMeasurement,
    shareProgress, copyProgressLink, stopSharingProgress,
    // workout-ui-persistence.js
    loadHomeData,
    // workout-ui-home-strength-level-sync.js
    openSLHistorySync,
    closeSLHistorySync,
    // workout-ui-utils.js
    showMeasurements,
